...
GtkWidget *sc_cat; /* scrolled window */
GtkWidget *mo_cat; /* model categories */
GtkWidget *tv_cat; /* treeview categories */
GtkWidget *sc_act;
GtkWidget *mo_act;
GtkWidget *tv_act;
...
gint toolbar_noadd_close(void *item, GdkEvent *event, gpointer data)
{
...
gint toolbar_add_close(void *item, GdkEvent *event, gpointer data)
{
